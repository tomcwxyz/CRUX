...
import { buildObservationPlan, discoveryConnectors, suggestAIUseCandidates } from "@crux/core";
          ...
          <div className="ready">
            ...
            {observationPlan && <div className="observe-plan">
              ...
              <div className="choice-row" style={{paddingLeft:0,paddingRight:0,paddingBottom:0,background:"transparent",borderTop:0}}>
                <button className="btn" type="button">Generate patch proposal</button>
              </div>
            </div>}
