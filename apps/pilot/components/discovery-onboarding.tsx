        ...
        {(stage === "discover" || stage === "confirm") && (
          <>
            ...
            <div className="candidate">
              ...
              {stage === "discover" && <div className="choice-row"><button className="btn primary" type="button" onClick={goConfirm}>Yes — this is one AI use</button><button className="btn ghost" type="button" onClick={() => setNotSure(true)}>Not sure yet</button></div>}
              {stage === "discover" && notSure && <div className="not-sure" role="status">That's fine — nothing has been recorded. Unknown is a useful answer in CRUX. Come back when you know, or ask someone who works with this part of the system.</div>}
            </div>
              ...
              {declaration && (
                <div className="observe-plan">
                  ...
                  <div className="observe-grid">
                    ...
                    <div className="observe-box"><strong>AI can</strong><span>{power.charAt(0).toUpperCase() + power.slice(1)}{power === "act" ? ` · ${actionControlLabel(actionControl)}` : ""}</span></div>
                  </div>
                  <div className="choice-row" style={{paddingLeft:0,paddingRight:0,paddingBottom:0,background:"transparent",borderTop:0}}>
